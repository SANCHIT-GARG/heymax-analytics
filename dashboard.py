...
def load_data():
    ...
    return monthly_df, weekly_df, retention_month, retention_week

# Load Data
monthly_df, weekly_df, retention_month, retention_week = load_data()

# --- UI Toggle ---
view_option = st.radio("Select Time Granularity:", ["Monthly", "Weekly"])
...
with tab2:
    ...
    st.download_button("⬇️ Download Filtered Metrics", data=csv, file_name=f"{view_option.lower()}_growth_metrics.csv", mime="text/csv")
